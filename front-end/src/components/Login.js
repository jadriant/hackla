...
const Login = ({ setLanguage }) => {
    ...
    return (
        <div
            ...
            <div className="-mt-80">
                <div className="text-blue-500 text-3xl font-bold text-center mb-6">
                    Medical Grade Translator
                </div>

                <div className="flex flex-col space-y-4 items-center">

                    <button
                        className="bg-white text-gray-600 border border-gray-300 rounded-2xl px-2 py-2 cursor-pointer transition duration-300 ease-in-out w-11/12 font-medium tracking-wide mx-auto hover:shadow-lg flex items-center justify-center"
                    ...
                    <div>
                        <label htmlFor="language-select" className="text-lg font-medium text-blue-500">Language of Choice:</label>
                        <select
                            id="language-select"
